...
export class AppSidebarComponent {
    ...
    
    {
      ...
      subItems: [
        ...
        : [{ name: "Emprunts", path: "/my-loans", pro: false }, 
          { name: "Recommandations", path: "/recommandation", pro: false }]),
        ...(this.permissions.includes("loan:manage") || this.permissions.includes("loan:view") || this.permissions.includes("loan:view_all")
  ...
  othersItems: NavItem[] = [
    ...
    },
    {
      ...
      subItems: [
        { name: "Profil", path: "/settings", pro: false },
