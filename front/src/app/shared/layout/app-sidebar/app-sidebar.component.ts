  ...
  return  [
    {
      ...
      ...(this.permissions.includes("loan:manage" )
        ? [{ name: "Gestion des livres", path: "/crud-books", pro: true }]
    ...
    },
    {
      ...
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" xml:space="preserve"
        ...
        <path d="M36.5 51.325 32 56.234 11.725 34.116c-4.579-4.996-4.241-12.769.754-17.348 4.996-4.579 12.769-4.241 17.348.754L32 19.893l2.173-2.371c4.579-4.995 12.352-5.333 17.348-.754 4.995 4.579 5.333 12.352.754 17.348L42.5 44.839" />
        <path d="M14.868 31.187c-3.217-3.509-2.98-8.97.53-12.187M42 39v12M48 45H36" />
      </svg>`,
      name: "Mes favoris",
      path: "/favorites",
    ...
    },
    {
      ...
      subItems: [
        ...
        { name: "Emprunts", path: "/loan", pro: false }
      ],
    },
  ];
}
